...
Shawnee people, on whose ancestral homelands on whose
ancestral homelands I have worked on this presentation. 
}

\frame{\frametitle{Housekeeping and Notes on content}
  \begin{itemize}
...
\begin{itemize}
  ...
  language for the initial area of adventuring and off I went with that.
...
\begin{itemize}
  ...
  permission from the community, because it matters how a language is presented
  in fiction and therefore how real people are reflected in fiction.
